...
def convert_csvfile_umlsSimilarityFile(inpath, infilename, outpath, outfilename, sample=False):
...
def argumentParser():
    ...
    parser.add_argument('-s', '--sample', type=bool, required=False, action='store', help='outfilename txt')
    return parser.parse_args()


def main():
    args = argumentParser()
    convert_csvfile_umlsSimilarityFile(args.inpath, args.infilename, args.outpath, args.outfilename, args.sample)
